...
{
    public partial class Loan_Loans
    {
        public Loan_Loans()
        {
            RiskRatingChanges = new HashSet<Loan_RiskRatingChanges>();
        }
        ...
        public virtual ICollection<Loan_RiskRatingChanges> RiskRatingChanges { get; set; }
    }
}
